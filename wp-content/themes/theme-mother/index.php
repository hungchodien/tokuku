                    ...
                    <div class="row">
                        <div class="swap-3-selectbox">
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 swap-select-box-ajax-search">
                                <select class="form-control select-box-ajax-data " id="area" data-slug="tourirt-tokuku-area" >
                            ...
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12 swap-select-box-ajax-search">
                                <select class="form-control select-box-ajax-data " id="nganh" data-slug="tourirt-tokuku-category" >
                                    ...
                                    foreach($terms as $key => $term){
                                        ?>
                                        <option class="ajax-nganh" data-id-area="<?php echo $term->term_id ;?>" value="<?php echo $term->term_id ;?>">
                                            <?php echo $term->name; ?>
                                        </option>
                                        <?php
                                    }
                            ...
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12  swap-select-box-ajax-search right">
                                <select class="form-control select-box-ajax-data " id="company" data-slug="cong-ty" >
                                    <option value="-1"> chọn công ty</option>
                                    <?php
                                    $args = array(
                                        'post_type' => 'cong-ty',
                                        'tax_query' => array(
                                    ...
                                    foreach ($query->posts as $key => $value){
                                        ?>
                                        <option
                                                class="ajax-none-company" value = "<?php echo get_permalink( $value->ID) ?>">
